...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'eiin',
                    models.CharField(
                        default='105409', editable=False, max_length=7
                    ),
                ),
                (
                    'established_at',
                    models.DateField(
                        default=datetime.date(1980, 1, 1), editable=False
                    ),
                ),
                (
                    'location_url',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'code',
                    models.CharField(
                        default='105409', max_length=10, unique=True
                    ),
                ),
                ...
                (
                    'logo',
                    models.ImageField(
                        blank=True, null=True, upload_to='schools/'
                    ),
                ),
        ...
        migrations.AddField(
            model_name='aclass',
            name='Subject',
            field=models.ManyToManyField(to='nphs_school.subject'),
        ),
    ]
