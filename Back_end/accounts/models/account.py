...
RELIGION_CHOICES = [(rel, rel.title()) for rel in ['islam', 'hindu', 'buddhist', 'christian']]
...
class Account(models.Model):
    ...
    last_educational_institute = models.CharField(
        max_length=120
        )
    ...
    def clean(self):
        ...
        if not re.fullmatch(r'8801[3-9]\d{8}', normalized):
            raise ValidationError({'mobile': "Invalid BD mobile after normalization."})
